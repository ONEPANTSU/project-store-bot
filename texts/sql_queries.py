...
select_seller_name_by_seller_id_query = "SELECT `telegram_name` FROM `seller` WHERE `id` = '%s';"
select_seller_id_by_project_id_query = "SELECT `seller_id` FROM `project` WHERE `id` = '%s';"
select_seller_id_by_seller_name_query = "SELECT `id` FROM `seller` WHERE `telegram_name` = '%s';"
select_project_by_seller_id_query = "SELECT * FROM `project` WHERE `seller_id` = '%s';"
select_project_by_seller_name_query = "SELECT project.id FROM `project` " \
                                        "INNER JOIN `seller` ON project.seller_id = seller.id  " \
                                        "WHERE `telegram_name` = '%s';"
select_projects_id_by_theme_id_query = "SELECT `project_id` FROM `project_theme` WHERE `theme_id` = '%s';"
select_all_project_info_by_id_query = "SELECT project.id, project.seller_id, project.name, project.price, " \
                                        ...
                                        "WHERE project.id = '%s';"
select_theme_name_by_theme_id_query = "SELECT `theme_name` FROM `theme` WHERE `id` = '%s';"
select_theme_id_by_theme_name_query = "SELECT `id` FROM `theme` WHERE `theme_name` = '%s';"
