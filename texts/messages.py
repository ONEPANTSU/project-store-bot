...
sell_menu_message =  "✔ Чтобы выставить свой проект на продажу, перейдите в пункт меню «Выставить проект на продажу» " \
...
status_question = "Хотите ли получить Premium-статус? \n\n" \
...
buy_menu_message = "✔ Здесь можно посмотреть список проектов на бирже \n\n" \
